...
module Capybara
  class Selector < SimpleDelegator
    ...
    def call(locator, **options)
      ...
      raise "Locator #{locator.class}:#{locator.inspect} for selector #{name.inspect} must #{locator_description}. This will raise an error in a future version of Capybara." unless locator_valid?(locator)
    end
